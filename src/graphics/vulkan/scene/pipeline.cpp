...
namespace SplitGui {
    inline void VulkanInterface::createScenePipelineLayout() {
        ...
        Logutil::info("Created Scene Pipeline Layout");
    }
    ...
    inline Result VulkanInterface::createScenePipeline(SceneObject& scene) {
        ...
        attributeDescriptions[SceneVertexLayout::eVertexColor].format         = vk::Format::eR32G32B32A32Sfloat;
        ...
        Logutil::info("Created Scene Graphics Pipeline");
